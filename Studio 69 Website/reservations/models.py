...
class Booking(models.Model):
    ...
    proof_of_payment = models.ImageField(upload_to='proofs/', blank=True, null=True)  # Example for ImageField, adjust as per your needs
    ...
    def __str__(self):
        return f"Booking {self.id} - Room {self.room.id} - User {self.user.username}"
